              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Divider(color: Colors.white12),
                    _buildTimelineItem(Icons.star, '课堂表现', '+1', '3月23日', '3月23日', Colors.purple),
                    const Divider(color: Colors.white12),
                    _buildTimelineItem(Icons.warning, '迟到', '-2', '3月22日', '3月22日', Colors.red),
                    const Divider(color: Colors.white12),
                    _buildTimelineItem(Icons.emoji_events, '进步奖励', '+20', '3月21日', '3月21日', Colors.amber),
                  ],
                ),
              ),
            ),
